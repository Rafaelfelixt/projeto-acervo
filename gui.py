...
def remover():
    ...
    if item_selecionado:
        ...
        session.delete(filme_selecionado)
        session.commit()
        visualizar()
...
def visualizar():
    ...
    # Nomeando as colunas
    visualizacao['show'] = 'headings' # Para mostrar apenas colunas com título
    ...
    for filme in lista_de_filmes:
        visualizacao.insert("", END, 
                            values=(filme.nome,filme.genero, filme.diretor,
                            filme.duracao, filme.ano))
